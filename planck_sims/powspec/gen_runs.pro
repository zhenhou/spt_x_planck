pro gen_runs, freq, planck_dr, submit=submit, ifield_start=ifield_start, ifield_end=ifield_end, partition=partition
    ...
    for ifield=ifield0, ifield1 do begin
        ...
        submit_file = 'scripts/submit_'+dr_str+'_hfi_'+freq_str+'_'+field_name+'.sh'
        ...
        printf, 5, 'cd /home/zhenhou/Projects/projects/spt_x_planck/planck_halfring_sims/powspec/'
        printf, 5, ' '
        ...
        printf, 5, '$IDL_DIR/bin/idl -e "make_halfring_sims_xspec, '+freq_str+', '+dr_str+', '+field_str+'"'
        close, 5
